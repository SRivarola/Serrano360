    ...
    <div className="trabajamosPresentacion">
      ...
      <div className="section1">
        <div className="parrafoContainer">
          <p >Hola! ¡Soy Maite!</p>
          <p >Hace mucho me gradué de la Universidad ORT (Uruguay) como Diseñadora Gráfica. Pero más adelante descubrí otra pasión, la fotografía.</p>
          <p >Estudié fotografía en diferentes escuelas de Arte y más adelante realicé trabajos como fotógrafa de familia y también de productos.</p>
        </div>
